...
Manager.prototype.getMagicHandleObject = function() {
  ...
  return Object.defineProperties({}, _.reduce(this._handles, function(obj, instance, name) {
    obj[name] = obj[name.toLowerCase()] = self.getMagicHandleDefinition(name);
    return obj;
  }, {}));
...
/**
 * Returns a setting for Object.defineProperty for getting the handle of a connection
 * @param {String} name Name of connection
 * @return {Object}
 */
Manager.prototype.getMagicHandleDefinition = function(name) {
  var instance = this.get(name);
  return {
    configurable: true,
    enumerable: true,
